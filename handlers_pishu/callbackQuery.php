...
switch ($update->callback_query->data) {
    case 'setbackground':
        ...
        dm("تصویر یا ویدیوی مورد نظر خود را ارسال کنید");
        break;
    
    case 'settext':
        setCheckpoint("text_1");
        dm("متن مورد نظر خود را بنویسید");
        break;
    ...
    case 'settext1_tkt':
        dm("متن اول را بنویسید");
        setCheckpoint("text1tkt");
        break;

    case 'settext2_tkt':
        dm("متن دوم را بنویسید");
        setCheckpoint("text2tkt");
        break;

    case 'settext3_tkt':
        dm("متن سوم را بنویسید");
        setCheckpoint("text3tkt");
        break;

    case 'settext4_tkt':
        dm("متن چهارم را بنویسید");
        setCheckpoint("text4tkt");
        break;

    case 'settext5_tkt':
        dm("متن پنجم را بنویسید");
